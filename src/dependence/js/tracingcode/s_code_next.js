...
function initVars(){
	...
	s.channel = s.eVar1 = s.eVar2 = s.eVar3 = s.eVar4 =s.eVar5 = s.eVar6 = s.eVar40= s.eVar66 = "";
	s.prop6 = s.events = s.hier1 = s.prop9 =s.prop10=s.eVar10="";
...
function getOmniSiteCd(){
	...
	/* CN Store */
	if (splitUrl[2] != undefined && ( splitUrl[2].indexOf("samsungshop.com.cn") != -1 || splitUrl[2].indexOf("samsungeshop.com.cn") != -1)) //18.08.24 update
	{
		siteCd = "cn";
	} 
...
else if(window.location.host == "origin2.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }
else if(window.location.host == "stgweb4.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }
else if(window.location.host == "p4.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal";}
else if(window.location.host == "ptcweb4.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal";}
else if(window.location.host == "www.eumysamsung.com") {s_account = "sssamsung4cn,sssamsung4mstglobal";}
else if(window.location.host == "my.eu.samsung.com") {s_account = "sssamsung4"+getOmniAccountSiteCd()+",sssamsung4mstglobal"; }
																	   
else if(window.location.host == "shop.samsung.com") { s_account = "sssamsung4"+getOmniAccountSiteCd()+",sssamsung4mstglobal"; }
...
else if(window.location.host == "www.samsungeshop.com.cn") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }	/* CN Store 18.08.20 update */
else if(window.location.host == "stage.samsungshop.com.cn") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }	/* CN Store */
else if(window.location.host == "org-kr.shop.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal";}
else if(window.location.host == "org-cn.shop.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal";}
else if(window.location.host == "stg-kr.shop.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }
else if(window.location.host == "stg-cn.shop.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }
else if(window.location.host == "stg.shop.samsung.com") { s_account = "sssamsung4cn,sssamsung4mstglobal"; }
...
else { s_account = "sssamsung4cn,sssamsung4mstglobal"; }
...
//micro site일때 자동 Exit Link track 하지 않음 
	  ...
	  /* SEC B2B, CN Store */
s.linkInternalFilters="JAVA-SCRIPT:,tel:,samsungshop.com.cn,samsungeshop.com.cn,www.samsungb2b.co.kr,www.samsung.com,japan.samsung.com,2.samsung.com,3.samsung.com,4.samsung.com,shop.samsung.com,store.samsung.com,local.sec.samsung.com,ru.samsung.com,eu.samsung.com"; 
...
function sDoPlugins(s) {
	...
	//SEBN sci 
	if(!s.eVar65)	s.eVar65 = s.getQueryParam('sci');
	...
	//s.prop12 = "high"; //18.06.05 prop12 Annotation 
	...
	if(logCheck == undefined && logCheck == null){
		...
		"au,cn,nz,es,fr,it,nl,de,se,uk,sec,ru,be,be_fr,pl,dk,fi,no,ch,ch_fr,pt".indexOf(getOmniSiteCd())!=-1? s.prop10 = "logged in": s.prop10 = "logged out";
	...
	//Devicetype
	//s.prop9 = getOmniDeviceType(); //18.06.05 prop9 Annotation 
...
*/
	...
	if(currentUrl.indexOf('/ng/') != -1){//Store Page
		...
		switch(getOmniSiteCd()) {
			...
			default : isPathindicatorEng = 'UKSTORE'; break; 
		}
	...
	} else if( currentUrl.indexOf('samsungshop.com.cn') != -1 || currentUrl.indexOf('samsungeshop.com.cn') != -1 ){	/* CN Store 18.08.20 update */
...
function sendPageCodeStore(){
	...
	//s.prop40 = s.pageName; //18.06.05 prop40 Annotation 
...
function sendPageCode(group, category){
	...
	try{
		...
		if(pageType != ""){
			...
			}else if(pageType.indexOf("product detail") != -1 || pageType.indexOf("instore product detail")!=-1){
				s.eVar11 = getOmniInputTagValue("pvi_type_name");
				s.eVar12 = getOmniInputTagValue("pvi_subtype_name");
				s.eVar13 = getOmniInputTagValue("pvi_project_name");
				s.eVar14 = getOmniInputTagValue("model_code");
...
function getPid(data){
	...
	// s.eVar9 = getOmniDeviceType(); //18.06.05 eVar9 Annotation 
...
function sendScRemove(order, mCode){ //18.01.05 update
...
function sendScCheckout(order, mCode){ //18.01.05 updated
	s.linkTrackVars="events,products,eVar41";
...
// collection product update 20191209  ************************************************************************************************************
function sendCollPro(mname,mcode) {
	s.linkTrackVars = "events,products,eVar41";
	s.linkTrackEvents = "scColl";
	if(mcode) {
		s.eVar41 = mcode.toUpperCase();
	}
	s.events="scColl";
...
function sendScPurchaseSucc(order,pId,dOption,pMethod,pOption,pviType,pviSubtype,pviDname,mCode,pGroup){ //18.01.05 updated
    var pOptions = "";
	...
	s.eVar15 = pviDname;
	s.eVar41 = mCode;
	//s.eVar53 = pGroup; //18.06.05 eVar53 Annotation 

	s.linkTrackVars="eVar37,events,products,purchaseID,prop38,eVar50,eVar11,eVar12,eVar15,eVar41,eVar53";
	s.linkTrackEvents="purchase,event53";

	s.events="purchase,event53";
	setClickVar();
	s.tl(true,"o","scPurchaseSucc");
	s.linkTrackVars='none';
	s.linkTrackEvents='none';
...
function sendClickCode( typeName, data, option ){
	...
	var trackVar = 	{ 
		...
		*/
		...
		"option_click" : "prop27=data#0|products=data#1|eVar41=data#2|type=o|trackname=jump to tracking",
	...
	// Product Detail Page, Business Detail Page, Support Detail Page, shop detail(추가, 2018/01/05)
	if ( getOmniInputTagValue("pageTrack").indexOf("product detail") != -1 || getOmniInputTagValue("pageTrack").indexOf("support detail") != -1 || getOmniInputTagValue("pageTrack").indexOf("shop detail") != -1){
...
function getdil_Local_Account(){
	...
	var useDilCountry =  ['sa','sa_en','uk','ae','ae_ar','fr','de','it','au','se','fi','no','dk',/*'ru'*/]
	var useDilYNCountry = "";
		...
		if(getOmniSiteCd() == useDilCountry[idx]){
			...
			switch(useDilCountry[idx]){
				...
				case 'dk'    : useDilYNCountry = 'samsung-nordics' 
				               break;
				/*case 'ru'  : useDilYNCountry = 'samsung_nordics' 
				               break;*/
